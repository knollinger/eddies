 ...
 *
 */
public class GetOpeningHoursModelHandler implements IXmlServiceHandler
{
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            rsp = AdminDBUtils.getOpeningHoursModel(conn);
        }
    ...
    @XmlRootElement(name = "get-opening-hours-model")
    @XmlType(name="GetOpeningHoursModelHandler.Request")
